...
public class CustomerDao extends AbstractDao<Customer, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Fin = new Property(3, String.class, "fin", false, "FIN");
        public final static Property Email = new Property(4, String.class, "email", false, "EMAIL");
        public final static Property Contact_name = new Property(5, String.class, "contact_name", false, "CONTACT_NAME");
        public final static Property Mobile_phone = new Property(6, String.class, "mobile_phone", false, "MOBILE_PHONE");
        ...
        public final static Property Address3 = new Property(10, String.class, "address3", false, "ADDRESS3");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CUSTOMER' (" + //
                ...
                "'FIN' TEXT," + // 3: fin
                "'EMAIL' TEXT," + // 4: email
                "'CONTACT_NAME' TEXT," + // 5: contact_name
                "'MOBILE_PHONE' TEXT," + // 6: mobile_phone
                "'PHONE' TEXT," + // 7: phone
                "'ADDRESS1' TEXT," + // 8: address1
                "'ADDRESS2' TEXT," + // 9: address2
                "'ADDRESS3' TEXT," + // 10: address3
    ...
    protected void bindValues(SQLiteStatement stmt, Customer entity) {
        ...
        if (contact_name != null) {
            stmt.bindString(6, contact_name);
        }
 
        String mobile_phone = entity.getMobile_phone();
        if (mobile_phone != null) {
            stmt.bindString(7, mobile_phone);
        }
    ...
    public Customer readEntity(Cursor cursor, int offset) {
        Customer entity = new Customer( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // fin
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // email
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // contact_name
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // mobile_phone
            ...
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // address3
    ...
    public void readEntity(Cursor cursor, Customer entity, int offset) {
        ...
        entity.setFin(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setEmail(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setContact_name(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setMobile_phone(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        ...
        entity.setAddress3(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
